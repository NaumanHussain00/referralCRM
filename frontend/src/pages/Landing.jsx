      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Enter your target company and role. Get a list of relevant LinkedIn
            profiles instantly. No premium subscription needed.
          </p>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="font-medium text-gray-900">
                          {["Amit Kumar", "Sarah Patel", "Raj Johnson"][i - 1]}
                        </div>
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-600">
                  Enter the company name and the role you're targeting. That's
                  it. No complex filters or boolean searches.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-600">
                  We search the web and return LinkedIn profiles of people who
                  match your criteria. Software Engineers at Google? Recruiters
                  at Meta? Done.
                </p>
              </div>
            </div>
      ...
      <footer className="py-8 border-t border-gray-200 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-gray-500">
            Built by{" "}
            <a
              href="https://linkedin.com/in/nauman-hussain-a89297262"
